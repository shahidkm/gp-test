...
const M2H = () => {
  ...
  const technologies = [
    ...
    { name: 'MVC', icon: Code, category: 'Backend' },
          ...
          <div className="flex rounded-2xl overflow-hidden backdrop-blur-md border border-white/20 shadow-2xl"
            ...
            {['overview', 'technologies', 'achievements'].map((tab) => (
              <button
                ...
                className={`px-6 py-3 font-medium capitalize transition-all duration-500 relative overflow-hidden ${activeTab === tab
